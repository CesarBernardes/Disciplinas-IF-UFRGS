...
///t_1->Draw("qinvSigSS>>hqinvSigSS","HFsumET>2300","goff"); //grupo4
////t_1->Draw("qinvSigSS>>hqinvSigSS","HFsumET>1000 && HFsumET<1850","goff"); //grupo2
t_1->Draw("qinvSigSS>>hqinvSigSS","HFsumET<800","goff"); //grupo3
////t_1->Draw("qinvSigSS>>hqinvSigSS","HFsumET>3400","goff"); //grupo1
h_qinv_sig_SS->Write();
